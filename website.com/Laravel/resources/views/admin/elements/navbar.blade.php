                ...
                <div class="collapse navbar-collapse " id="navbarSupportedContent">
                    <ul class="navbar-nav ml-auto navbar-right-top">
                        ...
                        <li class="nav-item dropdown nav-user">    
                            ...
                            <div class="dropdown">
                                <span><a class="nav-link nav-user-img"  id="navbarDropdownMenuLink2" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="admin/assets/images/avatar-1.jpg" alt="" class="user-avatar-md rounded-circle"></a></span>
                                    <div class="dropdown-content">
                                 <?php $user = Auth::user(); ?>
                        @if(isset($user))
                                        <p><a class="dropdown-item" ><i class="fas fa-user mr-2"></i>{{$user->name}}</a></p>
                                        <p><a class="dropdown-item" href="admin/user/edit/{{$user->id}}"><i class="fas fa-cog mr-2"></i>Setting</a></p>
                        @endif       
                                        <p><a class="dropdown-item" href="admin/logout"><i class="fas fa-power-off mr-2"></i>Logout</a></p>
                                    </div>
                            </div>
