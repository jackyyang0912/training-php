...
<div class="container-fluid">
    ...
    ?>
        ...
        <form action="<?= BASE_PATH . 'index.php?module=admin&controller=category_product&action=edit&id='. $this->item->id ?>" method="POST" enctype="multipart/form-data">
            <div class="card-body">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-10">
                        <div class="input-group input-group-sm mb-3">
                            <textarea name="decription" value="<?= $this->item->decription ?>" class="form-control" rows="5" id="comment"><?= $this->item->detail ?></textarea>
                        </div> 
                    </div>
                </div>
                <div class="row">
