    ...
    <div class="container-fluid">
        ...
        <form action="<?= BASE_PATH . 'index.php?module=admin&controller=category_product&action=index' ?>" method="GET">
            ...
            <div class="row">
                ...
                <div class="col-sm-1">
                    <button    class="btn-success btn-sm" id="ex3" ><a href='<?=BASE_PATH ?>index.php?module=admin&controller=category_product&action=add'> Thêm mới </a></button>
                </div>
            </div>
        </form>
        ...
        <div class="card shadow mb-4">
            <div class="card-body">
                ...
                <form action="<?=BASE_PATH . 'index.php?module=admin&controller=category_product&action=delete'?>" method="POST">
                        ...
                        <tbody>
                            <?php if($this->data){
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <button type="button" class="btn-info btn-sm" ><a href = '<?=BASE_PATH . 'index.php?module=admin&controller=category_product&action=delete'.'&id=' . $obj->id . '&image=' . $obj->image?>'> Xoá</a></button>
                                        <button type="button" class="btn-info btn-sm" ><a href = '<?=BASE_PATH . 'index.php?module=admin&controller=category_product&action=edit'.'&id=' . $obj->id?>'> Sửa</a></button>
                                    </td>
                                </tr>
                            <?php } }?>
                        </tbody>
