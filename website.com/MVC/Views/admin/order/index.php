                        ...
                        <tbody>
                            <?php if(isset($this->data)){
                                ...
                                <tr>
                                    ...
                                    <td>
                                    <?php 
                                        $url_status = BASE_PATH . 'index.php?module=admin&controller=order&action=changeStatus&status=' . $obj->status . '&id=' . $obj->id ;
                                        $url_detail = BASE_PATH . 'index.php?module=admin&controller=order&action=detail&id=' . $obj->id;
                                    ?>
                            ...
                            <?php 
                                if(isset($this->totalPage) ){
                                    for($i = 1 ; $i <= $this->totalPage ; $i++ ) { 
                                        $url_page = BASE_PATH . 'index.php?module=admin&controller=order&action=index&page=' . $i ;
