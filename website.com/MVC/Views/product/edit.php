                            ...
                            <form action="<?= BASE_PATH . 'index.php?controller=product&action=edit&id='. $this->item->id ?>" method="POST" enctype="multipart/form-data">
                                <div class="card-body">
                                                ...
                                                <select name="category_id" class="form-control">
                                                    <?php if($this->data_category_product) { ?>
                                                        <?php foreach($this->data_category_product as $row) { ?>
                                                            <option value="<?= $row->id == $this->item->category_id  ? 'selected' : '' ?>" value="<?= $row->id ?>"><?= $row->name ?></option>
                                                        <?php } ?>
                                                    <?php } ?>
                                                </select>
                                            </div> 
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="input-group input-group-sm mb-3">
                                                <textarea name="decription" value="<?= $this->item->decription ?>" class="form-control" rows="5" id="comment" ><?= $this->item->decription ?></textarea>
                                            </div> 
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-sm-10">
                                            <div class="input-group input-group-sm mb-3">
                                                <input type="file" name="image" value="<?= $this->item->image ?>">
                                            </div> 
                                        </div>
                                    </div>
                                    <div class="row">
